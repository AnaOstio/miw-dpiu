...
let MenuApp = ({ login, setLogin }) => {
    ...
    return (
        <>
            <Row style={{ width: "100vw", margin: 0, padding: 0, backgroundColor: "#001529" }} justify="space-between">
                <Col span={22} style={{ padding: 0, margin: 0 }}>
                    ...
                    {login && (
                        <Menu theme="dark" mode="horizontal" style={{ width: "100%", padding: 0, margin: 0 }} items={[
                            { key: "logo", label: <img src="/logo.png" width="40" height="40" style={{ display: "block", margin: "0 auto", paddingTop: "5px" }} /> },
